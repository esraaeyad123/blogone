    ...
    <div class="site-section bg-white">
       ...
       @foreach($posts as $post)
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="{{ route('website.post',['slug' => $post->slug])}}"><img  src="@if($post->image){{ asset($post->user->image) }} @else {{ asset('website/images/img_4.jpg') }} @endif"  alt="Image" class="img-fluid rounded"></a>
                            <div class="excerpt">
